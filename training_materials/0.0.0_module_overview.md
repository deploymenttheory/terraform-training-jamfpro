...
- **Complete: [VS Code for Infrastructure Engineers course](./vscode/module_00_course_overview.md)** - modular, docs-driven course with hands-on exercises and quizzes (modules 01-04 for this topic; modules 05-07 pair well with the Terraform topics later in this plan)
- What is VS Code?
